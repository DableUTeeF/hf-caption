...
class InterceptedGPT2Attention(nn.Module):
    def __init__(self, config, is_cross_attention=False, layer_idx=None):
        super().__init__()
        self._attn = DummyATTN()
    ...
    def forward(
        ...
        if self.reorder_and_upcast_attn:
            ...
            attn_output, attn_weights = self._attn(self, query, key, value, attention_mask, head_mask)
...
class CombinedEncoderDecoderModel(VisionEncoderDecoderModel):
    def forward(
            self,
            features=None,
            pixel_values=None,
...
class BackboneDINOEncoderDecoderModel(VisionEncoderDecoderModel):
    def forward(
            self,
            features_dd=None,
            features_bb=None,
